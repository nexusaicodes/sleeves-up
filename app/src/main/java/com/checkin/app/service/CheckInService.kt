 ...
 *
 * For what the package's other eight files do — almost all are `Session`-prefixed, so the prefix discriminates nothing
 * — see the layer map in [SessionSchedule]'s KDoc.
 */
